...
Public Class WulfsBNDBuild
    ...
    Public work As Boolean = False
    Public outputList As New List(Of String)
    ...
    Public Sub extract(ByVal extractFilename As String)
        SyncLock workLock
            work = True
        End SyncLock
        ...
        Try
            ...
            filepath = Microsoft.VisualBasic.Left(extractFilename, InStrRev(extractFilename, "\"))
            filename = Microsoft.VisualBasic.Right(extractFilename, extractFilename.Length - filepath.Length)
    ...
    Public Sub rebuild(ByVal rebuildFilename As String)
        SyncLock workLock
            work = True
        End SyncLock

        Try
            runRebuild(rebuildFilename)
        Catch ex As Exception
            output(TimeOfDay & " - Unhandled exception - " & ex.Message & Environment.NewLine)
        End Try
    ...
    Public Sub runRebuild(ByVal rebuildFilename As String)
        ...
        filepath = Microsoft.VisualBasic.Left(rebuildFilename, InStrRev(rebuildFilename, "\"))
        filename = Microsoft.VisualBasic.Right(rebuildFilename, rebuildFilename.Length - filepath.Length)
        ...
        Select Case Microsoft.VisualBasic.Left(fileList(0), 4)
            Case "BHD5"
                ...
                BDTFilename = Microsoft.VisualBasic.Left(rebuildFilename, InStrRev(rebuildFilename, ".")) & "bdt"
            ...
            Case "BHF3"
                ...
                Dim BDTFilename As String
                BDTFilename = Microsoft.VisualBasic.Left(rebuildFilename, rebuildFilename.Length - 3) & "bdt"
